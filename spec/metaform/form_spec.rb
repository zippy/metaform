  ...
  describe "-- dsl: " do
    ...
    describe "listing" do
      ...
      it "should return the number of items that match a fixed workflow_state filter" do 
         ...
         the_list = @form.listings['plain_with_workflow_state_filter']
         @records = the_list.fill_records({})
         @records.size.should == 3
      end
            
      it "should return the number of items that match a ruby filter" do
        the_list = @form.listings['filters']
        @search_params = {"on_main"=>"doula_name_begins_with", "for_main"=>"J"}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 2
        @search_params = {"on_main"=>"doula_name_begins_with_j_or_b", "for_main"=>"dummy"}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 3
      end
      ...
      it "should return the number of items that match a combination of ruby filters" do
        the_list = @form.listings['filters']
        @search_params = {"on_main"=>"doula_name_begins_with", "for_main"=>"J", "on_end"=>'doula_name_ends_with', "for_end" => 'e Smith'}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 1
        @search_params = {"on_main"=>"doula_name_is", "for_main"=>"Bob Smith", "on_age" => 'doula_age_is', "for_age" => '30'}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 1
      end
      ...
      it "should return the number of items that match a filter generated by the listing from a given pair" do
        the_list = @form.listings['generate_filters_by_name']
        @search_params = {"on_main"=>"doula_name_b", "for_main"=>"J"}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 2
        @search_params = {"on_main"=>"doula_name_c", "for_main"=>"Smith"}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 3
        @search_params = {"on_main"=>"doula_name_is", "for_main"=>"Bob Smith"}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 1
        @search_params = {"on_main"=>"doula_name_not", "for_main"=>"Bob Smith"}
        @records = the_list.fill_records(@search_params)
        @records.size.should == 3
      end
      ...
      it "should only prefill an AnswersHash with fields specified in the fields parameter" do
        ...
        @search_params = {"on_main"=>"doula_name_begins_with", "for_main"=>"J"}
        lambda {@records = the_list.fill_records(@search_params);@records[0].married}.should raise_error
        lambda {@records = the_list.fill_records(@search_params);@records[0].name}.should_not raise_error
      end
      
      it "should sort based on a sort rule" do
        the_list = @form.listings['sort_rules']
        # @search_params = {"order_current"=>"name","order_last"=>"practice_midwife","desc"=>"practice_midwife"}
        @search_params = {:order_current => "married_first"}
        @records = the_list.fill_records(@search_params)
      ...
      it "should sort based on a generated sort rule" do
        the_list = @form.listings['sort_rules']
        @search_params = {:order_current => "name"}
        @records = the_list.fill_records(@search_params)
      ...
      it "should sort based on a date sort rule" do
        the_list = @form.listings['sort_rules']
        @search_params = {:order_current => "favorite_date"}
        @records = the_list.fill_records(@search_params)
