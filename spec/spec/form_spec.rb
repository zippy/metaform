  ...
  describe "-- dsl: " do
    ...
    describe "c (define a condition)" do
      ...
      it "should assign the default condition ruby and javascript for simple conditions" do
        ...
        the_c.generate_javascript_function({'eye_color'=>[TextFieldWidget,nil]}).should == "function value_eye_color() {return values_for_eye_color};function has_black_eyes() {return value_eye_color()[cur_idx] == \"ffffff\"}"
        @form.with_record(@record) do
